...
| `customLogGroups`                          | A comma-separated list of custom log groups to collect logs from, or the ARN of the Secret parameter ([explanation below](#custom-log-group-list-exceeds-4096-characters-limit)) storing the log groups list if it exceeds 4096 characters.              | -                 |
...
### Changelog:
- **0.2.1**: Parallelized subscription filter updates to improve performance.
